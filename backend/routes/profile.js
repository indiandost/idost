...
router.post("/upload/:id", verifyToken, upload.single("photo"), async (req, res) => {
  ...
  try {
    ...
    console.log("API CALL PROFILE IMAGE");
    ...
    // =============================
    // ☁️ UPLOAD TO CLOUDINARY (SAME AS POSTS)
    // =============================
    const result = await new Promise((resolve, reject) => {

      const stream = cloudinary.uploader.upload_stream(
        {
          folder: "indiandost/profile",
          resource_type: "image",
           quality: "auto:good",
            fetch_format: "auto",
            width: 500,
...
router.post(
  ...
  async (req, res) => {
    ...
    try {
      ...
      // =============================
      // ☁️ UPLOAD ALL FILES TO CLOUDINARY
      // =============================
      for (const file of req.files) {
        ...
        const result = await new Promise((resolve, reject) => {
          ...
          const stream = cloudinary.uploader.upload_stream(
            {
              folder: "indiandost/photo", // 🔥 your cloud folder
              resource_type: "image",
               quality: "auto:good",
                fetch_format: "auto",
                width: 800,
